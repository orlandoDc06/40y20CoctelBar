...
public class CocineroAdapter extends RecyclerView.Adapter<CocineroAdapter.CocineroViewHolder> {

    private List<Usuario> usuarioList;
    private Context context;

    public CocineroAdapter(List<Usuario> usuarioList, Context context) {
    ...
    @NonNull
    @Override
    public CocineroAdapter.CocineroViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_usuarios, parent, false);
        return new CocineroViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CocineroAdapter.CocineroViewHolder holder, int position) {
        ...
        holder.imgItemEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CocineroDialog dialog = CocineroDialog.newInstance(usuario);
    ...
    public class CocineroViewHolder extends RecyclerView.ViewHolder {
        TextView lblItemNombre, lblItemRol;
        ImageView imgItemUsuario;
        ImageButton imgItemDelete, imgItemEdit;
        public CocineroViewHolder(@NonNull View itemView) {
            super(itemView);
