...
import com.example.a40y20coctelbar.dialogsAdmin.PendienteDialog;
...
public class PendienteAdapter extends RecyclerView.Adapter<PendienteAdapter.PendienteViewHolder> {
    ...
    public PendienteAdapter(List<Usuario> usuarioList, Context context) {
    ...
    @NonNull
    @Override
    public PendienteAdapter.PendienteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_usuarios, parent, false);
        return new PendienteAdapter.PendienteViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PendienteAdapter.PendienteViewHolder holder, int position) {
